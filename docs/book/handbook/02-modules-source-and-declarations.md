# Modules, source layout, and declarations
...
[projects and interfaces](10-projects-imports-and-interfaces.md) and the
...
accepted source forms. Declarations remain at module scope, project imports are
manifest-owned, and declaration names share one qualified namespace.
...
Continue with [values, types, and operators](03-values-types-and-operators.md).
The full grammar is the [Core appendix](../../CORE.md).
