...
<!-- slim-fixture: example-hello -->

The first program prints one line and returns process status zero. The next
fixture adds typed local values, operators, conversion, and integer output:
...
host services remain effect-gated. Incorrect indentation, commas, types, entry
signatures, and effects are compile-time diagnostics.

## Next

Continue with [modules, source layout, and declarations](02-modules-source-and-declarations.md)
