# RFC-0056: Typed match scrutinees
...
The RFC-0055 compiler accepts the new direct computed-variant fixture at check time
...
produce C byte-identical to RFC-0055.
