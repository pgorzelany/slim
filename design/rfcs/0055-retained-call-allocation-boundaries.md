# RFC-0055: Retained call allocation boundaries
...
RFC-0047 made the checked memory plan retain every call site that can propagate an
...
programs produce C byte-identical to RFC-0054. A dedicated executable fixture
...
allocation-capable calls and enforces a 1.25 endpoint exponent budget. RFC-0054
