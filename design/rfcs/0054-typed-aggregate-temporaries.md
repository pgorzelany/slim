# RFC-0054: Typed aggregate temporaries
...
After RFC-0053, computed call and recursive-transfer temporaries consumed the
...
typed-temporary programs produce C byte-identical to RFC-0053. The dedicated
...
1,000 field/payload pairs, an endpoint exponent of 0.714. RFC-0053 measured 3.795,
