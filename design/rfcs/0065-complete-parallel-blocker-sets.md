# RFC-0065: Complete parallel blocker sets
...
RFC-0064 proves that no existing application function is parallel-safe, but its
...
RFC-0066 later refines the meaning of `declared-effects`: the category remains in
