# RFC-0070: Tiered structured worker ABI
...
RFC-0069 requires a portable or explicitly tiered worker ABI before automatic
...
and multi-application evidence satisfy the remaining RFC-0069 conditions.
