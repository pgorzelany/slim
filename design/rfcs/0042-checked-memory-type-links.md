# RFC-0042: Checked memory type links
...
already receives checked tokens under RFC-0036, so its storage queries use the same
bounded path.
...
and backend callers already satisfy RFC-0036's checked-token precondition. An
