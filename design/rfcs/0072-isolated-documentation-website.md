# RFC-0072: Isolated documentation website
...
machine-readable documentation artifacts. RFC-0106 replaces the initial
...
Markdown build toolchain. RFC-0105 replaces the server wrapper and separate hosting
...
RFC-0106 retains those indexes and generates guide, language-reference, and
