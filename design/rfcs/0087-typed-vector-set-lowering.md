# RFC-0087: Typed vector-set lowering
...
specialize the generic helper but remains rejected by RFC-0059.
...
The RFC-0086 full result is the baseline. Typed set lowering improves the full
