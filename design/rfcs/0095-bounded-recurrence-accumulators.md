# RFC-0095: Bounded recurrence accumulators
...
RFC-0094 recovers an exact small counted recurrence and proves its controller
...
For a RFC-0094 recurrence only, the range view may promote an I64 parameter to a
...
body for a positively identified RFC-0094 loop. This is a fixed-factor linear
...
The RFC-0094 counted-control candidate preserves output and vector bounds checks
