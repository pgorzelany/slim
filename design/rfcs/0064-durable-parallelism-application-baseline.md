# RFC-0064: Durable parallelism application baseline
...
RFC-0062 and RFC-0063 establish bounded safety facts on focused fixtures, but focused
...
eleven stable primary-reason counts, and eligible sites. RFC-0065 advances it to
...
set of coexisting blockers. RFC-0064 therefore cannot by itself justify selecting
