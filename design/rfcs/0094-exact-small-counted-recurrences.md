# RFC-0094: Exact small counted recurrences
...
stage expansion accepted by RFC-0096. Every consumer must retain left-to-right
...
The rejected RFC-0089 induction candidate proved only one recurrence path and did
not materially improve the corpus. RFC-0094 instead records a complete multi-path
...
neutral; RFC-0095, RFC-0096, RFC-0097, and RFC-0098 together make the checked facts useful
