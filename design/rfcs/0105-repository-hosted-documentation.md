# RFC-0105: Repository-hosted documentation
...
The documentation website accepted by RFC-0072 is a generated static site, but its
...
`/status/` plus `llms.txt` and `reference/surface.json`. RFC-0106 adds only
...
and canonical repository inputs from RFC-0072.
