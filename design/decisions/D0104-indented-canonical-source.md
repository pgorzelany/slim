...
boundary in D0103 now lets the source parser change without rewriting typing,
...
independent D0103 checkpoint if the new parser cannot preserve direct AST
...
compatibility decision. D0103 keeps that future change local to parsing,
