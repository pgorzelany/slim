# D0071: Guarded automatic fork/join
...
D0069 deferred automatic execution until a tiered worker ABI, checked
...
application existed. D0070 supplies the worker boundary. This decision admits
...
the cost-model error rejected by D0069.
