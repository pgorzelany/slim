# D0040: Bounded variant member lookup
...
D0039 made exact variant case definitions part of the checked token artifact but
...
the exact checked stream as required by D0036. A defensive fallback preserves
...
regression in D0038, so this decision claims bounded variant members only.

## Evidence

The producer seed from D0039 builds this consumer without an out-of-band seed
