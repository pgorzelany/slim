# D0096: Bounded counted recurrence expansion
...
D0094's exact counted-loop fact and D0095's accumulator ranges remove proven
...
For a D0094 fact only, the compiler may emit one guarded `do` stage per exact
...
Expansion is limited by D0094's fixed maximum of 16 iterations.
